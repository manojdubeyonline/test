...
function validate(){
	...
	for(var m=0;m<grLevel;m++){
		for(var n=0;n<grLevel;n++){
			if( document.getElementById('ratesName'+m).value == document.getElementById('ratesName'+n).value && m != n){
				BootstrapDialog.alert('Two Rate Names can not be same at GR Level');
				return false;
			}	
		}
	}
	...
	<style>#grpo_direct{overflow-y:scroll;}</style>

<div class="modal fade" id="grpo_direct" role="dialog"
	aria-hidden="true">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class=" form-group">
						...
						<label for="item" style="margin-left:44%">Warehouse</label><input type="hidden" id="warehouse1"
							name="warehouse1">
						...
						<div class="col-md-6" >
						  <select  class="form-control"
							...
							<div class="col-md-6">
								<select class="form-control" id="warehouse" name="warehouse" onChange="generateRecieptNo();" required>
