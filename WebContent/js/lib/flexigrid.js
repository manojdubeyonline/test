...
(function ($) {
	$.addFlex = function (t, p) {
		...
		if (p.usepager) {
			...
			if(navigator.userAgent.match(/msie/i) && navigator.userAgent.match(/6/)) $('.pButton', g.pDiv).hover(function () {
		...
		if ($('th', g.hDiv).length) {
			...
			if (navigator.userAgent.match(/msie/i) && navigator.userAgent.match(/6/)) $('tr', g.nDiv).hover(function () {
	...
	$.fn.noSelect = function (p) { //no select plugin by me :-)
		...
		if (prevent) {
			return this.each(function () {
				...
				if (navigator.userAgent.match(/msie/i) || navigator.userAgent.match(/safari/i)) $(this).bind('selectstart', function () {
				//if ($.browser.msie || $.browser.safari) $(this).bind('selectstart', function () {
					return false;
				});
				else if (navigator.userAgent.match(/mozilla/i)) {//($.browser.mozilla) {
